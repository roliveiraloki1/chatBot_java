...
public class UserThread extends Thread {
    ...
    /**
     * construtor da thread dos usuários. Recebe o server a entrar e um socket
     * para o server
     *
    ...
    /**
     * método que envia a resposta do servidor para o usuário específico
     *
     * @param message Resposta do servidor
     */
